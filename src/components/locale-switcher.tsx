...
export default function LocaleSwitcher({ className }: LocalSwitcherProps) {
  ...
  return (
    ...
    >
      ...
      >
        <Menu.Items className="absolute z-10 mt-2 w-32 rounded-md border border-gray-900 ring-1 ring-black/5 focus:outline-hidden dark:border-white ltr:right-0 ltr:origin-top-right rtl:left-0 rtl:origin-top-left">
          <div className="py-1">
